...
def worldmap(dict_df,case_type,word_pic):
    ...
    for dates in merge.columns.to_list()[2:20]:
...
def dailyplotcountries(dict_df, countries):
    #TO DO: visualiser l’évolution journaliere du nombre cumulé des cas confirmés, morts, actifs et fermés pour un 
    #certain nombre de pays sélectionner.
    #TO DO: Creer des subfigure de 2 ligne et 2 colonne de dimension 17*10 

    #TO DO: Pour chacune des cle du dictionnaire dict_df visualiser l’évolution du nombre de cas pour chaque pays de coutries
    ...
    #TO DO: Pour chaque pays de coutries afficher un petit sommaire du nombre totales des cas confirmés, morts, actifs et fermés
...
def WeekofYear(df):
    #TO DO: regrouper les cle du dictionnaire dict_df par numero de semaine
    #TO DO: ajouter une colonne "WeekofYear" a la base de donnee df

    #TO DO: creer une nouvelle base de donnee week_df avec les memes colonnes que df

    #TO DO: Pout toutes les semaines de la base de donnee calculer la somme des cas de cette semaine pour remplir la base de donnee week_df
    # Exemple:
...
def weeklybar(dict_df, country):
    #TO DO: visualiser l’évolution hebdomadaire des cas confirmés, morts, actifs et fermés pour un de pays.
    #TO DO: Pour l'ensemble des cle du dictionnaire dict_df regrouper les bases de donner par "WeekofYear" pensez a utiliser la fonction
    # WeekofYear implementer precedement.

    #TO DO: Creer des subfigure de 2 ligne et 2 colonne de dimension 15*10 

    #TO DO: Pour chacune des cle du dictionnaire dict_df visualiser l’évolution hebdomadaire
